...
/*
    ...
    public static void debugSource(int sources, String prefix) {
        ...
        MuLog.v(TAG, prefix + "int=" + s_copy + " CLASS={" + cls + " } source(s):" + src);
    }
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        MuLog.v(TAG, "Device: " + Build.DEVICE);
        MuLog.v(TAG, "Model: " + Build.MODEL);
        MuLog.v(TAG, "onCreate()");
        super.onCreate(savedInstanceState);

        try {
            Thread.currentThread().setName("SDLActivity");
        } catch (Exception e) {
            MuLog.v(TAG, "modify thread properties failed " + e.toString());
        }
        ...
        // Keep compatibility with SDL2 variants that register nativeGetVersion().
        ...
        if (intent != null && intent.getData() != null) {
            ...
            if (filename != null) {
                MuLog.v(TAG, "Got filename: " + filename);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        MuLog.v(TAG, "onWindowFocusChanged(): " + hasFocus);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        MuLog.v(TAG, "onConfigurationChanged()");
    ...
    protected void onDestroy() {
        ...
        if (SDLActivity.mSDLThread != null) {
            ...
            try {
                ...
                MuLog.v(TAG, "Problem stopping SDLThread: " + e);
            }
        }
    ...
    protected static class SDLCommandHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (context == null) {
                MuLog.e(TAG, "error handling message, getContext() returned null");
                return;
            }
            switch (msg.arg1) {
            case COMMAND_CHANGE_TITLE:
                if (context instanceof Activity) {
                    ...
                    MuLog.e(TAG, "error handling message, getContext() returned no Activity");
                }
                break;
            ...
            default:
                if ((context instanceof SDLActivity) && !((SDLActivity) context).onUnhandledMessage(msg.arg1, msg.obj)) {
                    MuLog.e(TAG, "error handling message, command is " + msg.arg1);
                }
            }
        }
    }
    ...
    /**
     * This method is called by SDL using JNI to create a directory.
     */
    public static int CreateDirectory(String path) {
        try {
            java.io.File f = new java.io.File(path);
            return f.mkdirs() ? 0 : (f.exists() ? 0 : -1);
        } catch (Exception e) {
            return -1;
        }
    }
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint)
    {
        ...
        MuLog.v(TAG, "setOrientation() requestedOrientation=" + req + " width=" + w +" height="+ h +" resizable=" + resizable + " hint=" + hint);
...
*/
    ...
    public static boolean getManifestEnvironmentVariables() {
        try {
           ...
           MuLog.v(TAG, "exception " + e.toString());
        }
        return false;
    }
...
//            MuLog.v("SDL", "key down: " + keyCode + ", deviceId = " + deviceId + ", source = " + source);
//        } else if (event.getAction() == KeyEvent.ACTION_UP) {
//            MuLog.v("SDL", "key up: " + keyCode + ", deviceId = " + deviceId + ", source = " + source);
//        }
    ...
    // =========================================================================
    // ARGMU SDL2 fork - custom Java stubs required by libSDL2.so nativeSetupJNI
    // =========================================================================

    public static int CreateTextView(int id, float x, float y, int w, int h,
            String text, int fontSize, int textColor, int bgColor, int align) {
        return 0;
    }

    public static boolean DeleteTextView(int id) {
        return true;
    }

    public static void HideTextView(int id, boolean hide) {}

    public static void SetTextToTextView(int id, String text) {}

    public static String GetTextFromTextView(int id) {
        return "";
    }

    public static float GetMeasureWidthTextView(int id, String text, int fontSize) {
        return 0f;
    }

    public static float GetMeasureHeightTextView(int id, String text, int fontSize) {
        return 0f;
    }

    public static void SetTextViewColor(int id, int r, int g, int b, int a) {}

    public static void SetBackgroundTextViewColor(int id, int r, int g, int b, int a) {}

    public static void SetTextViewPosition(int id, float x, float y) {}

    public static int CreateEditText(int id, String hint, String text,
            int fontSize, int w, int h, int textColor, int bgColor,
            int borderColor, int inputType, boolean multiline, boolean password) {
        return 0;
    }

    public static void DeleteEditText(int id) {}

    public static void ShowEditText(int id, boolean show) {}

    public static void SetTextToEditText(int id, String text) {}

    public static String GetTextFromEditView(int id) {
        return "";
    }

    public static void SetEditTextPosition(int id, float x, float y) {}

    public static void SetFocusToEditText(int id, boolean focus) {}

    public static boolean GetFocusFromEditText(int id) {
        return false;
    }

    public static boolean isKeyEnterPressedOnEditText(int id) {
        return false;
    }

    public static void ShowListView(boolean show, int id) {}

    public static void AddTextToListView(String text, int color, int bgColor, int borderColor) {}

    public static void SetTextToListView(int id, int index, String text, int color, int bgColor) {}

    public static String GetTextFromListViewClicked(boolean clicked) {
        return "";
    }

    public static int GetIndexFromListViewClicked(int id) {
        return -1;
    }

    public static void SetListViewPosition(int id, int x, int y, int w, int h) {}

    public static void ClearListView(int id) {}

    public static void UpdateListView(int id) {}

    public static int GetColorID(int id) {
        return 0;
    }

    public static int GetBackgroundColor(int id) {
        return 0;
    }
    ...
    public static void AddNewContentView(View view) {
        if (mSingleton != null && view != null) {
    ...
    public static void DeleteContentView(View view) {
        if (mSingleton != null && view != null) {
            mSingleton.runOnUiThread(() -> {
                if (mLayout != null) {
    ...
    public static boolean CheckUpdatePlayStore() {
        return false;
    }

    public static String convertCStringToJniSafeString(byte[] bytes) {
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            MuLog.v("SDL", "modify thread properties failed " + e.toString());
        }

        MuLog.v("SDL", "Running main function " + function + " from library " + library);

        SDLActivity.nativeRunMain(library, function, arguments);

        MuLog.v("SDL", "Finished main function");
...
class SDLInputConnection extends BaseInputConnection {
    ...
    public boolean deleteSurroundingText(int beforeLength, int afterLength) {
        // Some IMEs only emit backspace through deleteSurroundingText.
    ...
    protected void updateText() {
        ...
        if (matchLength < text.length()) {
            ...
            StringBuilder filteredCommitText = new StringBuilder();
            for (offset = 0; offset < pendingText.length(); ) {
                int codePoint = pendingText.codePointAt(offset);
                if (codePoint == '\n' || codePoint == '\r') {
                    SDLActivity.onNativeSoftReturnKey();
                    filteredCommitText.append('\n');
                    offset += Character.charCount(codePoint);
                    continue;
                }
                ...
                filteredCommitText.appendCodePoint(codePoint);
                offset += Character.charCount(codePoint);
            }
            if (filteredCommitText.length() > 0) {
                SDLInputConnection.nativeCommitText(filteredCommitText.toString(), 0);
            }
        }
        mCommittedText = text;
    }
