...
namespace SEASON3B
{
	...
	private:
		...
		CNewUIBCustomMenuInfo*			m_pNewBCustomMenuInfo;
		/*CNewUIMacro*					m_pNewBMacroInfo;*/
		...
		CNewUIMasterSkillTree*				m_pNewMaster_SkillTree_Interface;
	...
	public:
		...
		CNewUIBCustomMenuInfo* GetUI_NewBCustomMenuInfo() const;
		/*CNewUIMacro*			GetUI_NewBMacroInfo() const;*/
		...
		CNewUIMasterSkillTree* GetUI_NewMasterSkillTreeInterface() const;
...
#define BConverITEM(x, y)					((x * 512) + y)
...
#define g_pBCustomMenuInfo SEASON3B::CNewUISystem::GetInstance()->GetUI_NewBCustomMenuInfo()
//#define g_pBMacroInfo SEASON3B::CNewUISystem::GetInstance()->GetUI_NewBMacroInfo()
...
#define g_pMasterSkillTreeInterface SEASON3B::CNewUISystem::GetInstance()->GetUI_NewMasterSkillTreeInterface()
