...
bool M34CryWolf1st::RenderCryWolf1stObjectVisual(OBJECT* o, BMD* b)
{
	...
	switch(o->Type)
	{
		...
		case 37:
			...
			break;
	case 84:
		if (ShouldEmitStableAmbientFrame(o, 3, 84) && m_OccupationState == CRYWOLF_OCCUPATION_STATE_OCCUPIED)
		{
			Vector(1.f, 1.f, 1.f, Light);
...
bool M34CryWolf1st::RenderCryWolf1stObjectMesh(OBJECT* o, BMD* b, int ExtraMon)
{
	...
	case 57:
	{
		if (ShouldEmitStableAmbientFrame(o, 4, 57))
		{
			Vector(1.f, 1.f, 1.f, Light);
			CreateParticle(BITMAP_TRUE_FIRE, o->Position, o->Angle, Light, 5, o->Scale, o);
			CreateParticle(BITMAP_SMOKE, o->Position, o->Angle, Light, 21, o->Scale, o);
		}
	}
	return true;
	case 71:
	{
		if (ShouldEmitStableAmbientFrame(o, 4, 71))
		{
			Vector(1.f, 1.f, 1.f, Light);
			CreateParticle(BITMAP_TRUE_FIRE, o->Position, o->Angle, Light, 5, o->Scale, o);
		}
	...
	case 74:
	{
		if (ShouldEmitStableAmbientFrame(o, 3, 74) && m_OccupationState == CRYWOLF_OCCUPATION_STATE_OCCUPIED)
		{
			Vector(1.f, 1.f, 1.f, Light);
			CreateParticle(BITMAP_SMOKE, o->Position, o->Angle, Light, 21, o->Scale, o);
		}
