...
struct CharacterPerfSnapshot
{
    ...
    int renderPlayers = 0;
    int renderMonsters = 0;
    int renderMonsterObjectCalls = 0;
    unsigned long long moveTicks = 0;
    unsigned long long renderTicks = 0;
    unsigned long long renderMonsterObjectTicks = 0;
    unsigned long long renderShadowTicks = 0;
    unsigned long long renderPostTicks = 0;
    unsigned long long renderAttachmentTicks = 0;
};
