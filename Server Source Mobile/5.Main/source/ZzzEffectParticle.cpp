...
#if defined(__ANDROID__) || defined(MU_IOS)
	if (ShouldThrottleAdaptiveEffectSpawn(ADAPTIVE_EFFECT_PARTICLE, Type, Position, SubType, Scale, Owner))
	{
		return false;
	}
#endif
...
#define PARTICLE_ENABLE_ALPHA_BLEND3() EnableAlphaBlend3()
	...
	for (int i = 0; i < MAX_PARTICLES; i++)
	{
		...
		if (o->Live)
		{
			...
			case BITMAP_BUBBLE:
				Frame = o->Frame % 9;
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, 0.f, Frame % 3 * 0.25f + 0.005f, Frame / 3 * 0.25f + 0.005f, 0.25f - 0.01f, 0.25f - 0.01f);
				break;
			case BITMAP_SPOT_WATER:
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height * 0.125, o->Light, o->Angle[0], 0.f, o->Frame % 8 * 0.125f, 1.f, 0.125f);
				break;

			case BITMAP_SPARK + 2:
				if (o->SubType == 0 || o->SubType == 2 || o->SubType == 3)
				{
					RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, 0.f, o->Frame % 2 * 0.5f, o->Frame / 2 * 0.5f, 0.5f, 0.5f);
				}
				break;

			case BITMAP_EXPLOTION_MONO:
			case BITMAP_EXPLOTION:
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, 0.f, o->Frame % 4 * 0.25f + 0.005f, o->Frame / 4 * 0.25f + 0.005f, 0.25f - 0.01f, 0.25f - 0.01f);
				break;
			case BITMAP_EXPLOTION + 1:
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width * 0.25f, Height, o->Light, o->Angle[0], o->Frame % 4 * 0.25f, 0.f, 0.25f, 1.f);
				break;
			case BITMAP_SUMMON_SAHAMUTT_EXPLOSION:
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, 0.f, o->Frame % 4 * 0.25f + 0.005f, o->Frame / 4 * 0.25f + 0.005f, 0.25f - 0.01f, 0.25f - 0.01f);
				break;
			case BITMAP_CLUD64:
			{
				if (o->SubType == 0 || o->SubType == 5 || o->SubType == 11)
				{
					PARTICLE_ENABLE_ALPHA_BLEND_MINUS();
				}
			...
			case BITMAP_TORCH_FIRE:
			{
				...
				for (int i = 0; i < 3; ++i)
				{
					RENDER_PARTICLE_SPRITE(o->Type, vPos, Width, Height, o->Light, o->Rotation);
			...
			case BITMAP_GHOST_CLOUD2:
			{
				RENDER_PARTICLE_SPRITE(o->Type, o->Position, Width, Height, o->Light, o->Rotation);
			}
			break;
			case BITMAP_LIGHT + 3:
			{
			...
			case BITMAP_SMOKE:
				...
				if (o->SubType == 6)
				{
					RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light);
				}
				else
				{
					RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, o->Rotation);
			...
			case BITMAP_BLOOD + 1:
				...
				break;
			case BITMAP_CHROME_ENERGY2:
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width * 0.25f, Height, o->Light, o->Rotation, o->Frame % 4 * 0.25f, 0.f, 0.25f, 1.f);
				break;
			case BITMAP_FIRE_CURSEDLICH:
			case BITMAP_FIRE_HIK2_MONO:
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, o->Rotation);
			...
			case BITMAP_FIRECRACKER:
			{
				...
				for (int j = iCount; j >= 0; --j)
				{
					...
					RENDER_PARTICLE_SPRITE(o->TexType, Position, Width, Height, Light, o->Rotation);
				}
			}
			break;
			case BITMAP_FLARE:
			...
			case BITMAP_CLOUD:
				...
				if (o->SubType == 8 || o->SubType == 9 || o->SubType == 20 || o->SubType == 21)
				{
					...
					RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, Light, o->Rotation);
				}
				else if (o->SubType == 17)
				{
					RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, o->Rotation);
			...
			case BITMAP_SHINY + 6:
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, o->Light, o->Rotation);
				RENDER_PARTICLE_SPRITE(BITMAP_LIGHT, o->Position, Width, Height, o->Light, o->Rotation);
				break;
			case BITMAP_SMOKELINE2:
			{
				if (o->SubType == 3)
			...
			case BITMAP_SBUMB:
			{
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width * 0.25f, Height, o->Light, 0.0f, o->Frame % 4 * 0.25f + 0.005f, 0.0f, 0.25f - 0.01f, 1.0f);
			}
			break;
			case BITMAP_DAMAGE1:
			{
			...
			case BITMAP_SWORD_EFFECT_MONO:
			{
				...
				RENDER_PARTICLE_SPRITE(o->TexType, vPos, Width * 0.9f, Height * 1.1f, o->Light, o->Rotation);
			}
			break;
			case BITMAP_DAMAGE2:
			{
				...
				RENDER_PARTICLE_SPRITE(o->TexType, o->Position, Width, Height, vLight, o->Rotation);
			}
			break;
			case BITMAP_TRUE_FIRE:
			default:
...
#undef PARTICLE_ENABLE_ALPHA_BLEND3
}
