...
void CMsgBoxIGSStorageItemInfo::Render3D()
{
	if( m_wItemCode==65535 )
		return;
	//if (m_wItemCode <= MODEL_SWORD)
	//{
	//	RenderItem3D((GetPos().x + IGS_3DITEM_POS_X)-25, GetPos().y + IGS_3DITEM_POS_Y, IGS_3DITEM_WIDTH, IGS_3DITEM_HEIGHT, m_wItemCode, 0, 0, 0, true);
	//}
	//else
	{
