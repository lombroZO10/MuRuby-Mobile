...
//        case    18 :
	...
	bool RenderBattleCastleVisual(OBJECT* o, BMD* b)
	{
		...
		{
		case 0:
			if (IsBattleCastleStart() == false && ShouldEmitStableAmbientFrame(o, 4, 0))
			{
				Vector(1.f, 1.f, 1.f, Light);
				CreateParticle(BITMAP_TRUE_FIRE, o->Position, o->Angle, Light, 0, o->Scale, o);
			}
			break;
		...
		case 42:
			if (IsBattleCastleStart() && ShouldEmitStableAmbientFrame(o, 3, 42))
			{
				Vector(1.f, 1.f, 1.f, Light);
				CreateParticle(BITMAP_SMOKE, o->Position, o->Angle, Light, 21, o->Scale, o);
			}
			break;
		case 52:
			if (IsBattleCastleStart() == false && ShouldEmitStableAmbientFrame(o, 2, 52))
			{
				Vector(1.f, 1.f, 1.f, Light);
				CreateParticle(BITMAP_WATERFALL_5, o->Position, o->Angle, Light, 6, o->Scale, o);
			}
			break;
		case 53:
			if (IsBattleCastleStart() && ShouldEmitStableAmbientFrame(o, 4, 53))
			{
				Vector(1.f, 1.f, 1.f, Light);
				CreateParticle(BITMAP_TRUE_FIRE, o->Position, o->Angle, Light, 0, o->Scale, o);
			}
			break;
		case 54:
			if (IsBattleCastleStart() == false && ShouldEmitStableAmbientFrame(o, 2, 54))
			{
				Vector(1.f, 1.f, 1.f, Light);
#if defined(__ANDROID__) || defined(MU_IOS)
				const int waterfallBitmap = ((((int)o->Position[0]) ^ ((int)o->Position[1])) & 1) ? BITMAP_WATERFALL_4 : BITMAP_WATERFALL_3;
#else
				const int waterfallBitmap = BITMAP_WATERFALL_3 + (rand() % 2);
#endif
				CreateParticle(waterfallBitmap, o->Position, o->Angle, Light, 0, 1.f, o);
			}
			break;
		}
