...
namespace SEASON3B
{
	...
	public:
		...
		int GetHotKeyInventoryIndex(int iHotKey, bool bItemCount = false);
		bool UseHotKey(int iHotKey);
		void UseItemRButton();
		void RenderItems();
	...
	public:
		...
		bool Update();
		bool Render();
		bool RenderMuHelper(float X, float Y, int SkillSelect, int SkillBuff = 0);
		...
		void RenderSkillIconPreview(int iSkillIndex, float x, float y, float width, float height);
		bool IsSkillPickerOpen() const;
		void SetSkillPickerOpen(bool open);
		void ToggleSkillPicker();
	...
	private:
		...
		int m_iAndroidTouchAssignSkillIndex;
	...
	public:
		...
		int GetItemHotKeyInventoryIndex(int iHotKey, bool bItemCount = false);
		bool UseItemHotKey(int iHotKey);
	...
	private:
		bool RenderSS2();
		void RenderLifeManaSS2();
		void RenderGuageSDSS2();
		void RenderGuageAGSS2();
		void RenderExperienceSS2();

		void RenderButtonsSS2();
		POINT ButtonSS2;
		float ButtonSS2W;
		float ButtonSS2H;
