...
CServerManager::CServerManager() // OK
{
	...
	this->m_SecurityWindowTick = 0;

	this->m_SecurityRequestWindowTick = 0;

	this->m_SecurityLastLogTick = 0;

	this->m_SecurityLastUnknownLogTick = 0;

	this->m_SecurityWindowCount = 0;

	this->m_SecurityUnknownCount = 0;

	this->m_SecurityConnectAccountCount = 0;

	this->m_SecurityMapMoveCount = 0;
