...
public:
	...
	int m_CurUserCount;
	int m_MaxUserCount;
	DWORD m_SecurityWindowTick;
	DWORD m_SecurityRequestWindowTick;
	DWORD m_SecurityLastLogTick;
	DWORD m_SecurityLastUnknownLogTick;
	DWORD m_SecurityWindowCount;
	DWORD m_SecurityUnknownCount;
	DWORD m_SecurityConnectAccountCount;
	DWORD m_SecurityMapMoveCount;
	DWORD m_SecurityRegisterCount;
};
